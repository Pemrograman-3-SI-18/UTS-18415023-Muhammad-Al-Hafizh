            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">18415023</div>
                  <div>Muhammad Al Hafizh</div>
                </div>
              </div>
      ...
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px;" class="bg-white text-bold">
            <q-item-section>
              Aplikasi Penjualan Makanan Khas Palembang
            </q-item-section>
          </q-item>
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              ...
              <div class="text-weight-bold">18415023</div>
              <div>Muhammad Al Hafizh</div>
            </div>
          </q-item>
          <q-item-label
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/inputdatamakanan">
            <q-item-section avatar>
              <q-icon name="input" />
            </q-item-section>
            <q-item-section>
